		...
		<li class="projektea">
			...
			<div class="projekteb submenu">
				<ul>
					...
					<li><a href="checkliste_dinslaken.php?d1=Projekte&d2=Checkliste Dinslaken&d3=">Checkliste Bauen für alle barrierefrei der Stadt Dinslaken</a></li>
					<li><a href="barrierefreie_dokumente_duisburg.php?d1=Projekte&d2=Barrierefreie Dokumente Duisburg&d3=">Barrierefrei aufbereitete Dokumente der Stadt Duisburg</a></li>
					...
					<li><a href="nedoshessen.php?d1=Projekte&d2=Nedos Hessen&d3=">NedosHessen</a></li>
					<li><a href="elektronische_literaturversorgung.php?d1=Projekte&d2=Elektronische Literaturversorgung&d3=">Elektronische Literaturversorgung für Sehgeschädigte</a></li>
					<li><a href="linux_fuer_blinde.php?d1=Projekte&d2=Linux für Blinde&d3=">Linux für Blinde</a></li>
					<li><a href="intranetportal.php?d1=Projekte&d2=Intranetportal&d3=">Intranetportal des BliZ</a></li>
					<li><a href="geldboerse_fuer_blinde.php?d1=Projekte&d2=Geldbörse für Blinde&d3=">Geldbörse für Blinde</a></li>
		...
		<li class="fachbereicha">
			...
			<div class="fachbereichb submenu">
				...
				<ul>
					...
					<li><a href="polizeiakademie_hessen.php?d1=Fachbereich&d2=Archiv&d3=Polizeiakademie Hessen">Polizeiakademie Hessen</a></li>
					<li><a href="10_jahre_bliz.php?d1=Fachbereich&d2=Archiv&d3=10 Jahre BliZ">10 Jahre BliZ</a></li>
					<li><a href="arbeitskreis_disability.php?d1=Fachbereich&d2=Archiv&d3=Arbeitskreis Disability Studies">Arbeitskreis Disability Studies</a></li>
					<li><a href="wissenschaft_ohne_barrieren.php?d1=Fachbereich&d2=Archiv&d3=Wissenschaft ohne Barrieren">Wissenschaft ohne Barrieren</a></li>
					<li><a href="tag_offenen_tuer.php?d1=Fachbereich&d2=Archiv&d3=Tag der offenen Tür">Tag der offenen Tür</a></li>
					<li><a href="bericht_eines_jahrespraktikanten.php?d1=Fachbereich&d2=Archiv&d3=Bericht eines Jahrespraktikanten">Bericht eines Jahrespraktikanten</a></li>
				</ul>
			</div>
		</li>
