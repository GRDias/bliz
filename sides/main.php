<div id="content">	
	...
	<div id="contentLeft">
		<div id="haupttext">
			...
			<ul class="squareDots">
				...
				<li>Anpassung von Lehrunterlagen für rehabilitationstechnische Geräte</li>
				<li>Durchführung von barrierefreien Klausuren</li>
				<li>Hilfsmittelpool zur Ausleihe</li>
				<li>Infoveranstaltungen für Schüler</li>
				<li>Beratung / Information von Dozenten und Mitarbeitern der THM</li>
				<li>Zimmervermittlung</li>			
	    		<li>...</li>
			</ul>
		</div>
		<div id="aktuelles">
	...
	<div id="sidebar">
		<ul class="sidebox redBox">
			<li><a href="profil.php?d1=Fachbereich&d2=Profil&d3="><h3>Fachbereich</h3></a></li>
		 	<li><a href="">Dekanat</a></li>
		 	<li><a href="">Über den Fachbereich</a></li>
		 	<li><a href="">Team</a></li>
		 	<li><a href="">Ausstattung</a></li>
		 	<li><a href="">Anfahrt</a></li>
		</ul>		
		
		<ul class="sidebox blueBox">
			<li><a href="studium.php?d1=Studium&amp;d2=&amp;d3="><h3>Studium</h3></a></li>
			<li><a href="barrieren_minimieren.php?d1=Studium&amp;d2=Barrieren%20minimieren&amp;d3=">Barrieren mit uns minimieren</a></li>
			<li><a href="blick_ins_bliz.php?d1=Studium&amp;d2=Blick%20in%20das%20Bliz&amp;d3=">Blick in das BliZ</a></li>
			<li><a href="faqs.php?d1=Studium&amp;d2=FAQs&amp;d3=">FAQs</a></li>
			<li><a href="auslandsbericht_riza.php?d1=Studium&amp;d2=Auslandsbericht%20Ali-Riza&amp;d3=">Auslandsbericht Ali-Riza C.</a></li>
			<li><a href="info_lehrkraefte.php?d1=Studium&amp;d2=Informationen%20für%20Lehrkräfte&amp;d3=">Informationen für Lehrkräfte</a></li>
		</ul>
	</div>
</div>
