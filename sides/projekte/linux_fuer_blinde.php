<?php include "sides/mininavi_2.php"; ?>
	...
	<div id="linuxBlinde">
		...
		<p>
			Unter Linux sind die befehlsorientierte Textkonsole und die grafische Oberfläche voneinander getrennt. Schon 1996 gab es die ersten Entwicklungen eines Screenreaders für die Textkonsole. Dieser Screenreader namens <a href="http://mielke.cc/brltty/">brltty</a> unterstützt eine Vielzahl von Braillezeilen und einige Hardwaresynthesizer sowie Softwaresprachausgaben. Zudem kann brltty an diverse Anwendungen angepasst werden. brltty wird auch heute noch weiterentwickelt.
			<br /><br />
			Der heute bekannteste Screenreader für die Textkonsole ist <a href="https://www.suse.com/de-de/?NPSPath=/webredesign/htdocs/de/whitepapers/blinux/index.html">Suse-Blinux</a>. Der von der Firma Suse Linux AG entwickelte, frei verfügbare, Screenreader liegt seit Version 7.0 der Distribution Suse Linux bei.
			Es unterstützt neben vielen Braillezeilen und Hardwaresprachausgaben auch die freie Softwaresprachausgabe txt2pho bzw. mbrola und Suse Blinux, eine Unterstützung für <a href="http://www.cstr.ed.ac.uk/projects/festival/">festival</a> ist in Entwicklung.
