<?php include "sides/mininavi_2.php"; ?>
			...
			<div>
				...
				<img src="bliz/img/jobline-jobsuche.jpg" alt="Screenshot der Jobsuche" class="centerImgy" />
				
				<br /><br />
				<ul class="numberDots">
					<li>
						Man kann explizit nach einer Berufsbezeichnung suchen, die in das Feld "Berufsbezeichnung" eingegeben wird. Hierzu können noch weitere Angaben gemacht werden, um die Suche nach den folgenden Kriterien einzuschränken:
